...
export default function HeaderSection() {
  ...
  const handleLanguageChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    setLanguage(lang);
    // Redirige a la URL deseada según el idioma seleccionado.
    window.location.href = `/${lang}/documentacion`;
  };
    ...
    <div className="relative">
      ...
      <div className="absolute left-0 right-0 md:top-4 mx-auto w-full flex flex-col md:flex-row justify-between items-center px-4">
        ...
        <select
          ...
          className="bg-gray-700 text-white p-2 rounded-md focus:outline-none mt-2 md:mt-0"
        >
